            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h1 class="text-uppercase">Shop Online<br>FOR <span id="js-rotating" class="text-uppercase">{{$categoriesNames}}</span></h1>
                        <p class="p-large">Minimall is your go-to app for convenient grocery shopping, offering a wide
                            range of products, easy navigation, and seamless checkout. Enjoy hassle-free grocery
                            shopping with Minimall's user-friendly interface and reliable delivery service.</p>
            ...
            <ul class="nav nav-tabs" id="lenoTabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab"
                        aria-controls="tab-1" aria-selected="true"><i class="fas fa-edit"></i>FEATURES</a>
                </li>
                <li class="nav-item">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ul class="list-unstyled li-space-lg">
                    ...
                    <li><i class="fas fa-map-marker-alt"></i>441, Jivandhara Society, Kathodra, Surat - 394326.</li>
